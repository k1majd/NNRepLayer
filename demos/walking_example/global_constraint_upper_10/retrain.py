...
if __name__ == "__main__":
    ...
    x_train, y_train = hand_label_samples(
        train_obs, train_ctrls, model_orig, bound_upper, gap=0.4
    )
    ...
    # model.evaluate(test_obs, test_ctrls, verbose=2)
    ...
    sat_rate, mae = give_stats(
        model, test_obs, test_ctrls, ctrl_test_pred_orig, bound_upper
    )
    ...
    sat_repair = give_sat_rate(
        model, x_train, y_train, ctrl_train_pred_orig, bound_upper
    )
