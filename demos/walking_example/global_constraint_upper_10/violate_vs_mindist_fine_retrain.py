...
def give_dist_n_violate(path_to_folder, num_models, x_test, bound):
    means = []
    dists = []
...
def get_x_y_test(bound):
    ...
    y_temp = model_orig.predict(x_test)
...
if __name__ == "__main__":
    ...
    # plot data
    plt.plot(dist_fine_tune, mean_fine_tune)
    plt.plot(dist_retrain, mean_retrain)
