...
if __name__ == "__main__":
    ...
    ax10.set_xlabel("Number of experiments", fontsize=14)
    ax11.set_xlabel("Number of experiments", fontsize=14)
    ax00.set_ylabel("MAE", fontsize=14)
    ax10.set_ylabel("Repair efficacy [\%]", fontsize=14)
    # ax01.set_ylabel("L-inf norm")
    ax01.set_ylabel("Number of \n repaired weights", fontsize=14)
    # ax11.set_ylabel("MIP gap")
    ax11.set_ylabel("MIQP cost", fontsize=14)
    ...
    ax00.axhline(
        ...
        linewidth=1.5,
        linestyle="dashed",
        label="The upper and lower bounds of partial repair",
    )  # lower bound
    ax00.axhline(
        y=0.5,
        color=color_ref,
    ...
    ax11.set_yscale("function", functions=(forward, inverse))
    ax11.set_ylim(np.min(cost_list) - 10, np.max(cost_list) + 10)
