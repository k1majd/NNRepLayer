...
ax00.set_xticks(np.linspace(0, T * (x_max - x_min) - 10.8, 5, endpoint=True))
...
ax10.set_xlim([0, T * (x_max - x_min) - 10.8])
ax10.set_ylim([-3, 3])
ax10.set_xticks(np.linspace(0, T * (x_max - x_min) - 10.8, 5, endpoint=True))
