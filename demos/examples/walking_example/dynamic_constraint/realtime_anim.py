...
if __name__ == "__main__":
    ...
    for i in range(len(delta_u_laye3_bound1_5)):
    ...
    y_pred_lay3_bound1_5 = y_pred_lay3_bound1_5.flatten()
    ...
    delta_u_laye3_bound1_5 = delta_u_laye3_bound1_5.flatten()
    delta_u_orig = delta_u_orig.flatten()

    # def data_gen():
    #     for cnt in range(600):
    #         print(cnt)
    #         yield time[cnt], y_test[cnt], y_pred_orig[
    #             cnt
    #         ], y_pred_lay3_bound1_5[cnt], delta_u_orig[
    #             cnt
    ...
    def init():
        ...
        del time_data[:]
        del y_test_data[:]
        del y_pred_orig_data[:]
        del y_pred_lay3_bound1_5_data[:]
        del delta_u_orig_data[:]
        del delta_u_laye3_bound1_5_data[:]
        line01.set_data(time_data, y_test_data)
        line02.set_data(time_data, y_pred_orig_data)
        line03.set_data(time_data, y_pred_lay3_bound1_5_data)
        line11.set_data(time_data, delta_u_orig_data)
        line12.set_data(time_data, delta_u_laye3_bound1_5_data)
        return line01, line02, line03, line11, line12
    ...
    ax00.set_title("Control rate bound = 1.5 [deg/s]", fontsize=14)
    ...
    (
        ...
        y_test_data,
        y_pred_orig_data,
        y_pred_lay3_bound1_5_data,
        delta_u_orig_data,
        delta_u_laye3_bound1_5_data,
    ) = (
        [],
        [],
        [],
    ...
    #         y_test,
    #         y_pred_orig,
    #         y_pred_lay3_bound1_5,
    #         delta_u_orig,
    #         delta_u_laye3_bound1_5,
    #     ) = data
    #     time_data.append(t)
    #     y_test_data.append(y_test)
    #     y_pred_orig_data.append(y_pred_orig)
    #     y_pred_lay3_bound1_5_data.append(y_pred_lay3_bound1_5)
    #     delta_u_orig_data.append(delta_u_orig)
    #     delta_u_laye3_bound1_5_data.append(delta_u_laye3_bound1_5)
    #     xmin, xmax = ax00.get_xlim()

    #     if t >= xlim_max / 2:
    #         ax00.set_xlim(t - frame / 2, t + frame / 2)
    #         ax00.figure.canvas.draw()
    #         ax10.set_xlim(t - frame / 2, t + frame / 2)
    #         ax10.figure.canvas.draw()
    ...
    def run(i):
        ...
        y_pred_orig_data.append(y_pred_orig[i])
        y_pred_lay3_bound1_5_data.append(y_pred_lay3_bound1_5[i])
        delta_u_orig_data.append(delta_u_orig[i])
        delta_u_laye3_bound1_5_data.append(delta_u_laye3_bound1_5[i])
        xmin, xmax = ax00.get_xlim()
