...
def plotTestData(
    ...
    plt.savefig(
        path_write
        + f"/repaired_model_32_nodes_backward_{layer_to_repair}{now_str}.png"
    )
...
if __name__ == "__main__":
    ...
    for layer_to_repair in layer_list:
        ...
        # repair the network
        ctrl_model_orig = repair_obj.repair(options)
        plotTestData(
            ctrl_model_orig,
            train_obs,
            train_ctrls,
