...
if not os.path.exists(path + "/data/input_output_data_tc1.pickle"):
    raise ImportError("path {path}/data/input_output_data_tc1.pickle does not exist!")
...
with open(path + "/data/input_output_data_inside_train_tc1.pickle", "wb") as data:
...
if not os.path.exists(path + "/data"):
    os.makedirs(path + "/data")
with open(path + "/data/input_output_data_inside_test_tc1.pickle", "wb") as data:
